#Copyright 2015 Daniel Foreman-Mackey This is open source software written by Dan Foreman-Mackey and released under   
...
def pcp(M, delta=1e-6, mu=None, maxiter=500, verbose=False, missing_data=True,
    ...
    lam = 2.0 / np.sqrt(np.max(shape)) ## author:1.0, Saina: 2.0 based on a paper
    if mu is None:
